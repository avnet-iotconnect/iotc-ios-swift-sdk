...
//            arrCalcDictEdgeDevice.append(["id":id ?? "","tg":tg ?? "","dt":"","d":[
...
//            }
            ...
            if let valDict = value as? [String:Any]{
                arrCalcDictEdgeDevice.append(anotherDict: ["id":id ?? "","tg":tg ?? "","dt":dt,"d":[
                    "\(key)":["\(value)","\(value)","\(value)","\(value)","1.0","\(value)"]]])
            }else{
                arrCalcDictEdgeDevice.append(anotherDict: ["id":id ?? "","tg":tg ?? "","dt":dt,"d":[
                    "\(key)":["\(value)","\(value)","\(value)","\(value)","1.0","\(value)"]]])
...
//            }
    ...
    func validateLatLong(value:String)->Bool{
